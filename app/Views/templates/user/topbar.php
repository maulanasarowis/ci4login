    ...
    <div class="row gx-0">
        <div class="col-lg-3 bg-dark d-none d-lg-block">
            <a href="index.html" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                <h1 class="m-0 text-primary text-uppercase">nginap</h1>
            </a>
        </div>
        <div class="col-lg-9">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0 float-right">
                        ...
                        <?php else : ?>
                            ...
                            class="btn btn-outline-primary rounded-0 py-4 px-md-5 d-lg-block text-capitalize">Masuk<i class="fa fa-arrow-right ms-3"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
            </nav>
